...
export default function PaymentReturnPage() {
  ...
  return <main className="callback-page"><Seo title="Confirming payment" description="Return securely to Jela AI after Paystack checkout." path="/payment-return" /><section className="status-panel" aria-live="polite">
